...
%token INTEGER_CONSTANT FLOAT_CONSTANT CHARACTER_CONSTANT STRING_LITERAL CONST_SYM

%token AUTO_SYM BREAK_SYM CASE_SYM CONTINUE_SYM DEFAULT_SYM 
%token DO_SYM ELSE_SYM ENUM_SYM FOR_SYM IF_SYM
%token RETURN_SYM SIZEOF_SYM STATIC_SYM STRUCT_SYM
%token SWITCH_SYM TYPEDEF_SYM UNION_SYM WHILE_SYM

%token PLUSPLUS MINUSMINUS ARROW LSS GTR LEQ GEQ
%token EQL NEQ AMPAMP BARBAR DOTDOTDOT LP RP LB RB LR RR
%token COLON PERIOD COMMA EXCL STAR SLASH PERCENT
%token AMP SEMICOLON PLUS MINUS ASSIGN
